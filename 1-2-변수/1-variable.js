...
num = 10 // 값 10으로 변경
console.log(num *2 );       //초기 변수 선언시에는 var 사용 그 이후에는 var사용 안해두 댐

//변수 선언 (생성)
// var 7friendName;    //변수 선언시 첫글자에 숫자 and 숫자만으로 만드는거는 안됨

// var friend name;  // 이름을 지을  때 띄어쓰기 불가능

var my_friend_name;  //snake case : SQL. python '언더바사용'
