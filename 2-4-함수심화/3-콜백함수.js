...
// 함수를 마치 하나의 값처럼 사용하여 변수에 저장하거나 다른 함수에 전달하거나 리턴할 수 있음

function substract(n1 , n2){
  return n1 - n2 ;}

let orange = substract;  //함수를 호출한게 아니라 함수 자체를 orange에 저장한것임
console.log(`orange: ${typeof orange}`);  //typeof orange : function
...
printSubstract(function (n1, n2) {  //무기명함수를 substract에 전달 가능
  return n1 * n2;  //두수를 곱해서 리턴하는 새로운 함수를 substract에 전달
});  //restult : 40
