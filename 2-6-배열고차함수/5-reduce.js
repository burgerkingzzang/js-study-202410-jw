...
// reduce 사용예시 > 사과 바구니에 있는 모든 사과들의 당도를 합산해주세요
let totalSweet = 0;
...
function myReduce(callbackFn, initialValue) {
  ...
  //어떤 값을 지속적으로 누적할 변수: accumulator
  let accumulator = initialValue ? initialValue : appleBasket[0];  //initialValue가 있으면 accumulator에 저장, 없으면 배열에 저장
  let startIndex = initialValue ? 0 : 1;
  for(let i = 0 ; i < appleBasket; i ++){
